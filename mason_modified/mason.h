        ...
        Options<TReadsTag> const & options)
{
    ...
    do {
        ...
        unsigned readLength = max(1,min(pickReadLength(rng, options), length(haplotype[inst.contigId])-5));
...
//          size_t libraryLength = pickLibraryLength(rng, options);   LLL Not needed
